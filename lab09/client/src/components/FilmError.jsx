    ...
    return (
        <>
            <Container className={"fluid d-flex justify-content-center align-items-center"} style={{height: "30rem"}}>
                <Image src={pixar} style={{width: "20rem", height: "20rem"}} className="d-none d-sm-none d-md-none d-lg-block rounded-circle"/>
                    <div>
                        <div className={"d-flex justify-content-center align-items-center"}><strong className={"primary-text"} style={{fontSize: "3rem", textAlign: "center"}}>{props.error}</strong></div>
