...
function FilmLibrary(films) {
    ...
    this.populateHTML = function(all) {
        ...
        for(let film of all) {
            ...
            input.setAttribute("class", "favCheckbox");
            ...
            td = document.createElement("td");
            td.setAttribute("class", "text-center");
            if(film.rating == null) td.innerHTML = "Unrated";
            else td.innerHTML = "<div class=\"rating\">\n" +
                ...
                "            </div>";
            newRow.appendChild(td);
            if(film.rating != null) updateRating(newRow, film.rating);

            td = document.createElement("td");
            td.setAttribute("class", "text-center");
            td.innerHTML = "<button class=\"btn btn-primary rounded-square\" style=\"background-color: #2F3B50;\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"16\" height=\"16\" fill=\"currentColor\" class=\"bi bi-trash3\" viewBox=\"0 0 16 16\">\n" +
    ...
    this.switchContext = function(context) {
        ...
        films = document.querySelectorAll(".film");
        films.forEach( film => {
            let trash = film.querySelector(".bi-trash3");
