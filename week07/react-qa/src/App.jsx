...
function MyRow(props) {
  const { e } = props; //const e = props.e --> JavaScript convoluto
  return (
    <tr>
...
function MyTable(props) {
  ...
  function increaseScore(id) {
    ...
    setList((oldList) => oldList.map((e) => {
      if (e.id === id) {
        return Object.assign({}, e, { score: e.score + 1 });  //per evitare di assegnare tutti i campi di e, Object.assign crea un nuovo oggetto e modifica solo il campo specificato
      } else {
        return e;
      }
    })
